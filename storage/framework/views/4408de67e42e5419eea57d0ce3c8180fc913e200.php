...
<div>
    ...
    <div class="container">
        ...
        <p class="detail-desc">
            <?php if(app()->getLocale() == "id"): ?>
                <?php echo e($tourist->description_id); ?>

            <?php else: ?>
                <?php echo e($tourist->description_en); ?>
        ...
        <div class="bg-light text-dark rounded p-2 mb-4 mt-5">
            <div class="d-flex justify-content-between align-items-center" id="title-label">
                <div class="fw-bold fs-4 d-flex align-items-center"><span class="bg-success rounded-circle me-2" style="display:inline-block; width:20px; height:20px;"></span><?php echo e(__('data.detail.location')); ?></div>
        ...
        <div class="bg-light text-dark rounded p-2 mb-4"  id="title-label-2">
            <div class="d-flex justify-content-between align-items-center" id="title-label">
                <div class="fw-bold fs-4 d-flex align-items-center"><span class="bg-success rounded-circle me-2" style="display:inline-block; width:20px; height:20px;"></span><?php echo e(__('data.detail.price')); ?></div>
                <div class="dropdown-toggle"></div>
            </div>
            <div class="temp-value-label mt-2" id="value-label-2">
                <?php if(app()->getLocale() == 'en'): ?>
                    <?php if($tourist->price_estimate == "Gratis"): ?>
                        Free
                    <?php else: ?>
        ...
        <div class="bg-light text-dark rounded p-2 mb-4" id="title-label-3">
            <div class="d-flex justify-content-between align-items-center" id="title-label">
                <div class="fw-bold fs-4 d-flex align-items-center"><span class="bg-success rounded-circle me-2" style="display:inline-block; width:20px; height:20px;"></span><?php echo e(__('data.detail.time')); ?></div>
                <div class="dropdown-toggle"></div>
            </div>
            <div class="temp-value-label mt-2" id="value-label-3">
                <?php if(app()->getLocale() == "en"): ?>
                    <?php if($tourist->time == "24 Jam"): ?>
                        24 Hours (WIB)
                    <?php else: ?>
    ...
    <div class="container my-5">
        <div class="fs-1 fw-bold custom-txt mb-3"><?php echo e(__('data.detail.title')); ?></div>
        ...
        <div class="ctr-rev">
            <div class="frontend-view pe-3">
                <?php if(count($post) < 1): ?>
                    <div class="fst-italic text-white opacity-50 fs-5 h-100 d-flex justify-content-center align-items-center">
                        <?php echo e(__('data.detail.empty')); ?>
                        ...
                        <div class="bor-btm ps-1 mt-1 mb-4">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="w-50 d-flex">
                                    <div class="rounded" style="width: 70px; height: 70px; background-image: url(<?php echo e(asset('storage/avatars/' . $data->post_belongsTo_user->image)); ?>); background-size: cover; background-position: center center"></div>
                                    <div class="ps-3 d-flex flex-column justify-content-center">
                                        <div class="fw-bold custom-txt auth-name"><?php echo e($data->post_belongsTo_user->name); ?></div>
                                    ...
                                    <?php if(Auth::user()->id == $data->user_id): ?>
                                        <form id="<?php echo e($temp2); ?>" action="<?php echo e(route('post_edit_logic')); ?>" class="temp-value-label position-relative mt-2" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="d-flex justify-content-between me-3">
                                                ...
                                                <input type="text" class="edit" name="review" placeholder="<?php echo e(__('data.detail.edit.placeholder')); ?>" id="review">
                                                <button type="submit" class="btn-edit"><?php echo e(__('data.detail.edit.btn_chg')); ?></button>
                                            </div>
                                        </form>
                                    <?php endif; ?>
                                </div>
            ...
            <form action="<?php echo e(route('insert_review')); ?>" class="d-flex gap-3 pt-3" method="POST" enctype="multipart/form-data">
                ...
                <input class="comment-view" type="text" name="review" placeholder="<?php echo e(__('data.detail.placeholder')); ?>">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\BINUS5\WEB_PROG\LEC\PROJECT_LECTURE_GROUP\Revice_RedundantHops_MultiLang\resources\views/detail.blade.php ENDPATH**/ ?>