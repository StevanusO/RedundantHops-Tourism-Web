    ...
    <div class="profile-height d-flex align-items-center">
        ...
        <div class="w-100 d-flex justify-content-center">
            <div class="py-4 glass-white w-50 d-flex flex-column ustify-content-center align-items-center">
                <img class="d-flex justify-content-center rounded-circle" src="<?php echo e(asset('storage/avatars/' . Auth::user()->image)); ?>" style="width:180px; height:180px">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\BINUS5\WEB_PROG\LEC\PROJECT_LECTURE_GROUP\Redundant_Hops\resources\views/profile_user.blade.php ENDPATH**/ ?>